...
public class Level2Screen extends LevelScreen {
    ...
    private SmallPig smallPig, smallPig2;
    private MediumPig mediumPig, mediumPig2;
    ...
    private GlassHorizontal glassHorizontal1, glassHorizontal2;
    private SteelBlock steelBlock1, steelBlock2, steelBlock3, steelBlock4;
    ...
    public Level2Screen(COLE game, LevelSelectionScreen screen) {
        super(game);
        ...
        this.SAVE_FILE = "level2_save_file.txt";
        this.birdIndex = 0;
        this.isPaused = false;
        this.LEFT_BOUND = 0;
        this.BOTTOM_BOUND = 0;
    ...
    protected void createLevel() {
        ...
        smallPig = new SmallPig(physicsWorld.getWorld(), 560, 210);
        smallPig2 = new SmallPig(physicsWorld.getWorld(), 550, 232);
        mediumPig = new MediumPig(physicsWorld.getWorld(), 470, 270);
        mediumPig2 = new MediumPig(physicsWorld.getWorld(), 630, 210);
        ...
        woodBlock4 = new WoodBlock(physicsWorld.getWorld(), 595, 170, 0);

        glassBlock1 = new GlassBlock(physicsWorld.getWorld(), 500, 132, 0);
        glassBlock2 = new GlassBlock(physicsWorld.getWorld(), 500, 200, 0);
        glassBlock3 = new GlassBlock(physicsWorld.getWorld(), 470, 132, 0);
        glassBlock4 = new GlassBlock(physicsWorld.getWorld(), 470, 200, 0);

        glassHorizontal1 = new GlassHorizontal(physicsWorld.getWorld(), 560, 230, 0);

        steelBlock1 = new SteelBlock(physicsWorld.getWorld(), 590, 235, 0);
        steelBlock2 = new SteelBlock(physicsWorld.getWorld(), 670, 132, 0);
        ...
        materials.add(glassHorizontal1);
...
//            System.out.println(birdCount);
        ...
        if(pigCount <= 0){
            ...
            levelSelectionScreen.completedLevel2();
