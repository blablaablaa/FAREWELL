...
public class Level3Screen extends LevelScreen {
    ...
    private SmallPig smallPig, smallPig2, smallPig3;
    private MediumPig mediumPig, mediumPig2, mediumPig3, mediumPig4;
    ...
    private SteelBlock steelBlock1, steelBlock2, steelBlock3, steelBlock4, steelBlock5, steelBlock6;
    private GlassHorizontal glassHorizontal, glassHorizontal2, glassHorizontal3;
    ...
    public Level3Screen(COLE game, LevelSelectionScreen screen) {
        super(game);
        ...
        this.SAVE_FILE = "level3_save_file.txt";
        this.birdIndex = 0;
        this.isPaused = false;
        this.LEFT_BOUND = 0;
        this.BOTTOM_BOUND = 0;
    ...
    protected void createLevel() {
        ...
        birds.add(new BombBird(physicsWorld.getWorld(), 140, 190));
        birds.add(new RedBird(physicsWorld.getWorld(), 100, 135));
        birds.add(new BlueBird(physicsWorld.getWorld(), 55, 135));
        birds.add(new BombBird(physicsWorld.getWorld(), 9, 135));
        if (!birds.isEmpty()) {
            catapult.holdBird(birds.get(birdIndex));
        }
        smallPig = new SmallPig(physicsWorld.getWorld(), 495, 132);
        smallPig2 = new SmallPig(physicsWorld.getWorld(), 585, 132);
        smallPig3 = new SmallPig(physicsWorld.getWorld(), 665, 132);
        mediumPig = new MediumPig(physicsWorld.getWorld(), 480, 190);
        mediumPig2 = new MediumPig(physicsWorld.getWorld(), 532, 280);
        mediumPig3 = new MediumPig(physicsWorld.getWorld(), 690, 190);
        mediumPig4 = new MediumPig(physicsWorld.getWorld(), 638, 290);
        largePig = new LargePig(physicsWorld.getWorld(), 585, 190);

        woodBlock1 = new WoodBlock(physicsWorld.getWorld(), 540, 132, 0);
        woodBlock2 = new WoodBlock(physicsWorld.getWorld(), 465, 132, 0);
        woodBlock3 = new WoodBlock(physicsWorld.getWorld(), 625, 132, 0);
        woodBlock4 = new WoodBlock(physicsWorld.getWorld(), 700, 132, 0);

        glassBlock1 = new GlassBlock(physicsWorld.getWorld(), 532, 180, 0);
//        glassBlock2 = new GlassBlock(physicsWorld.getWorld(), 532, 240, 0);
        glassBlock3 = new GlassBlock(physicsWorld.getWorld(), 630, 185, 0);
//        glassBlock4 = new GlassBlock(physicsWorld.getWorld(), 633, 240, 0);

        steelBlock1 = new SteelBlock(physicsWorld.getWorld(), 410, 132, 0);
        steelBlock2 = new SteelBlock(physicsWorld.getWorld(), 410, 170, 0);
        steelBlock3 = new SteelBlock(physicsWorld.getWorld(), 410, 210, 0);
        steelBlock4 = new SteelBlock(physicsWorld.getWorld(), 410, 250, 0);
        steelBlock5 = new SteelBlock(physicsWorld.getWorld(), 532, 240, 0);
        steelBlock6 = new SteelBlock(physicsWorld.getWorld(), 640, 250, 0);

        glassHorizontal = new GlassHorizontal(physicsWorld.getWorld(), 500, 170, 0);
        glassHorizontal2 = new GlassHorizontal(physicsWorld.getWorld(), 573, 170, 0);
        glassHorizontal3 = new GlassHorizontal(physicsWorld.getWorld(), 653, 170, 0);
        ...
        materials.add(glassBlock1);
//        materials.add(glassBlock2);
        materials.add(glassBlock3);
//        materials.add(glassBlock4);

        materials.add(steelBlock1);
        materials.add(steelBlock2);
        materials.add(steelBlock3);
        materials.add(steelBlock4);
        materials.add(steelBlock5);
        materials.add(steelBlock6);

        materials.add(glassHorizontal);
        materials.add(glassHorizontal2);
        materials.add(glassHorizontal3);
    }
...
//            System.out.println(birdCount);
        ...
        if(pigCount <= 0){
            ...
            levelSelectionScreen.completedLevel3();
...
//        debugRenderer.render(physicsWorld.getWorld(), camera.combined);
    }
